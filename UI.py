...
def figure():
    ...
    values_ = [13746, 1636]
    pie = go.Pie(labels=labels,values= values_,textposition='inside')
...
def create_app_ui():
    ...
    main_layout = dbc.Container(
        dbc.Jumbotron(
                [
                    html.H1(id = 'heading_main', children = project_name, className = 'display-3 mb-4'),
                    html.H3(id = 'heading1', children = 'A pie chart representation of the analysis:', className = 'mb-4'),
                    
                    dcc.Graph(id="pie", figure=figure(), style = {'margin-bottom': '50px'}),
                    
                    html.H3(id = 'heading2', children = 'Top 100 words:', className = 'mb-4'),
                    html.Img(id='wordcloudImg' , src = app.get_asset_url('wordcloud.png'), alt= 'Wordcloud', style = {'margin-bottom': '50px'}),
                                        
                    html.H3(id = 'heading3', children = 'Write a review or choose one from the dropdown menu:', className = 'mb-4'),
